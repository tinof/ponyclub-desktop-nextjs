// PERFORMANCE OPTIMIZATION: Temporarily disabled CSP middleware imports
...
// PERFORMANCE OPTIMIZATION: Temporarily disabled CSP configuration to enable static generation
