...
export default function Footer() {
  ...
  return (
      <footer className="relative bg-secondary border-t border-border"> {/* Removed mt-16 pt-12 pb-12 to eliminate spacing */}
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-5xl py-12"> {/* Added padding to the container instead */}
          <h2 className="text-center text-3xl mb-8 font-bold text-primary">
            {t.footer.contactUs}
          </h2>
