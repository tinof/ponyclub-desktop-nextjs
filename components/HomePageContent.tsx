    ...
    <>
      <main className='relative min-h-screen overflow-hidden'>
          ...
          <div className='absolute inset-0 flex items-center justify-center z-30'>
            <div className='relative bg-amber-800/40 px-4 py-3 sm:px-6 sm:py-4 rounded-2xl max-w-sm sm:max-w-md md:max-w-lg shadow-xl border-2 border-amber-200/50 backdrop-blur-xs transform hover:scale-[1.02] transition-transform duration-300'>
              ...
              >
                ...
                <span className='block font-extrabold tracking-wide text-white drop-shadow-[0_2px_3px_rgba(0,0,0,0.5)]'>
                  {t.hero.subtitle}
                </span>
              </h1>
        ...
        <div className='text-center mt-16 md:mt-20 flex flex-col items-center'>
          <h2
            className={`${robotoSlab.variable} font-roboto-slab text-4xl md:text-5xl font-bold text-[#3E5A35] mb-6 relative inline-block`}
          >
        ...
        <div className='text-center mt-16 md:mt-20'>
          <h2
            className={`${robotoSlab.variable} font-roboto-slab text-4xl md:text-5xl font-bold text-[#3E5A35] mb-12 md:mb-16 relative inline-block`}
          >
            {t.reviews.title}
            <div className='absolute -bottom-2 left-0 w-full h-1 bg-linear-to-r from-transparent via-[#6b8362] to-transparent'></div>
          </h2>
        ...
        <div className='px-4 md:px-8 mt-20 mb-20'>
          <h2
            className={`${robotoSlab.variable} font-roboto-slab text-center text-3xl md:text-4xl mb-10 text-[#6b8362]`}
          >
            {t.location.findUs}
          </h2>
