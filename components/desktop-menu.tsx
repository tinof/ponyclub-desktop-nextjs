  ...
  return (
    <nav className="flex items-center gap-4"> {/* Increased gap */}
      ...
      <div className="relative" ref={activitiesMenuRef}>
        ...
        {activitiesMenuOpen && (
          <div className="absolute left-0 mt-2 w-52 rounded-lg shadow-lg bg-card z-50 border border-border overflow-hidden"> {/* Cleaner dropdown style */}
            <div className="py-1">
      ...
      <div className="relative ml-2" ref={languageMenuRef}>
        ...
        {languageMenuOpen && (
          <div className="absolute right-0 mt-2 w-32 rounded-lg shadow-lg bg-card z-50 border border-border overflow-hidden"> {/* Cleaner dropdown style */}
            <div className="py-1">
              <button
                onClick={() => {
                  setLanguage("en")
