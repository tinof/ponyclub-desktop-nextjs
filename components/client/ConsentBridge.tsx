...
export default function ConsentBridge() {
  ...
  useEffect(() => {
    ...
    // For analytics, we'll treat it as separate from marketing by default
    // Users can control analytics through the privacy settings page
    // For now, analytics follows marketing consent but can be overridden
    const analyticsConsent = marketingConsent;
