    ...
    if (
      ...
      try {
        ...
        directionsButton.addEventListener('click', () => {
          window.open(`https://www.google.com/maps/dir/?api=1&destination=${BUSINESS_COORDINATES.lat},${BUSINESS_COORDINATES.lng}`, '_blank');
        });
  ...
  useEffect(() => {
    ...
    if (!consent?.analytics) {
      ...
      if (consent === null) {
        ...
        setError("Analytics cookies are required to display the interactive map. You can change your preferences in the cookie settings.");
      }
      return;
    }
