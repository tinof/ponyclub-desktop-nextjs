      ...
      <div className="relative w-full h-[60vh] md:h-[70vh] lg:h-[80vh]">
        ...
        <div className="absolute inset-0 flex items-start justify-center pt-10 md:pt-16">
          <div className="relative bg-amber-800/40 px-8 py-6 rounded-2xl max-w-3xl shadow-lg border-2 border-amber-200/50">
            ...
            >
              <span className="block mb-2 drop-shadow-[0_2px_3px_rgba(0,0,0,0.5)]">Rafting</span>
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="bg-white rounded-lg shadow-md p-8 mb-8">
          ...
          <div className="space-y-4">
            <p>Placeholder text for rafting description. This section will be updated with actual content later.</p>
            <p>Placeholder text describing the rafting experience, difficulty levels, and what to expect.</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-8">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-[#c27a5f]/10 p-6 rounded-lg">
              <h3 className="text-xl font-bold text-[#c27a5f] mb-2">Adults</h3>
              <p className="text-2xl font-bold">€40 per person</p>
              <p className="text-sm text-gray-600 mt-2">Ages 12+</p>
            </div>
            <div className="bg-[#6b8362]/10 p-6 rounded-lg">
              <h3 className="text-xl font-bold text-[#6b8362] mb-2">Children</h3>
              <p className="text-2xl font-bold">€30 per person</p>
              <p className="text-sm text-gray-600 mt-2">Ages 6-11</p>
            </div>
          </div>
        </div>
      </div>
