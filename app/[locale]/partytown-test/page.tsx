    ...
    <div className="container mx-auto p-8">
      ...
      <div className="space-y-4">
        <div className="p-4 bg-blue-50 rounded-lg">
          ...
          <p>This page tests if Partytown is working correctly with our third-party scripts.</p>
        </div>
        ...
        <div className="p-4 bg-green-50 rounded-lg">
          ...
          <ol className="list-decimal list-inside space-y-2">
            ...
            <li>Look for messages indicating scripts are running in web workers</li>
            <li>Check the Network tab for Partytown-related requests</li>
            <li>Verify that main thread is not blocked by third-party scripts</li>
          </ol>
        </div>
        ...
        <div className="p-4 bg-yellow-50 rounded-lg">
          ...
          <ul className="list-disc list-inside space-y-2">
            ...
            <li>Console should show "[GA] Google Analytics initialized in web worker"</li>
