...
export async function generateMetadata({
	...
	return {
		...
		keywords,
		alternates: {
			canonical: `https://www.ponyclub.gr/${locale}/packages/rafting-riding`,
			languages: {
				en: "https://www.ponyclub.gr/en/packages/rafting-riding",
				el: "https://www.ponyclub.gr/el/packages/rafting-riding",
			},
		},
		openGraph: {
			title: openGraphTitle,
			description: openGraphDescription,
			url: `https://www.ponyclub.gr/${locale}/packages/rafting-riding`,
			siteName: "Pony Club",
			images: [
				{
					url: "https://www.ponyclub.gr/images/packages/rafting-riding-package.jpg",
					width: 1200,
					height: 630,
					alt:
						locale === "el"
		...
		twitter: {
			...
			description: openGraphDescription,
			images: [
				"https://www.ponyclub.gr/images/packages/rafting-riding-package.jpg",
			],
		},
		robots: {
			index: true,
	...
	const breadcrumbData = generateBreadcrumbStructuredData(
		[
			...
			},
			{
				...
				url: `https://www.ponyclub.gr/${locale}#packages`,
			},
		],
