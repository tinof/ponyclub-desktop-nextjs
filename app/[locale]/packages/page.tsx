            ...
            <div className="grid gap-8 lg:grid-cols-2">
              ...
              <div className="flex justify-center">
                <VintagePackageCard
                  ...
                  activities={{
                    primary: isGreek ? "Ράφτινγκ: 30 λεπτά" : "Rafting: 30 minutes",
                    riding: isGreek ? "Ιππασία: 10-15 λεπτά" : "Riding: 10-15 minutes",
                    hiking: isGreek ? "Πεζοπορία διάσχισης φαραγγιού" : "Hiking canyon crossing",
                  }}
                  pricing={{
                    adults: "20 €",
                    children: "10 €",
              ...
              <div className="flex justify-center">
                <VintagePackageCard
                  ...
                  activities={{
                    primary: isGreek ? "Καγιάκ: 30 λεπτά" : "Kayak: 30 minutes",
                    riding: isGreek ? "Ιππασία: 10-15 λεπτά" : "Riding: 10-15 minutes",
                    hiking: isGreek ? "Πεζοπορία διάσχισης φαραγγιού" : "Hiking canyon crossing",
                  }}
                  pricing={{
            ...
            <div className="mt-16 rounded-2xl bg-gradient-to-r from-green-50 to-blue-50 p-8">
              <div className="text-center">
                <h3
                  ...
                  `}
                >
                  {isGreek ? "Γιατί να Επιλέξετε τα Πακέτα μας;" : "Why Choose Our Packages?"}
                </h3>
                <div className="mx-auto grid max-w-4xl gap-6 md:grid-cols-3">
                  ...
                  <div className="text-center">
                    <div className="mb-3 text-3xl">👨‍👩‍👧‍👦</div>
                    <h4 className="mb-2 font-semibold text-gray-800">
                      {isGreek ? "Ιδανικό για Οικογένειες" : "Perfect for Families"}
                    </h4>
                    <p className="text-sm text-gray-600">
                      {isGreek
                  ...
                  <div className="text-center">
                    <div className="mb-3 text-3xl">🌟</div>
                    <h4 className="mb-2 font-semibold text-gray-800">
                      {isGreek ? "Ολοκληρωμένη Εμπειρία" : "Complete Experience"}
                    </h4>
                    <p className="text-sm text-gray-600">
                      {isGreek
