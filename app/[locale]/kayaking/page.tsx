...
const KayakingPage = async ({ params }: PageProps) => {
  ...
  const seoContent = isGreek ? (
    <div className="mb-8">
      ...
      <div className="prose prose-lg max-w-none text-gray-700">
        <p className="lead mb-4">
          Ανακαλύψτε τη μαγεία του ποταμού Αχέροντα με μια συναρπαστική εμπειρία καγιάκ στα κρυστάλλινα νερά της Γλυκής, Θεσπρωτίας. 
          Το Pony Club προσφέρει ασφαλείς και οργανωμένες εκδρομές καγιάκ για όλες τις ηλικίες και επίπεδα εμπειρίας.
        </p>
        
        <p>
          Ο ποταμός Αχέροντας, γνωστός από την αρχαία ελληνική μυθολογία, είναι ένας από τους πιο εντυπωσιακούς προορισμούς 
          για καγιάκ στην Ελλάδα. Τα διαυγή νερά, η πλούσια βλάστηση και η μοναδική φυσική ομορφιά δημιουργούν το ιδανικό 
          περιβάλλον για μια αξέχαστη περιπέτεια στη φύση.
        </p>

        <p>
          Με τον έμπειρο εξοπλισμό και τους καταρτισμένους οδηγούς μας, θα απολαύσετε μια ασφαλή και διασκεδαστική εμπειρία καγιάκ 
          διάρκειας 30 λεπτών. Κατάλληλο για αρχάριους και παιδιά, με πλήρη εξοπλισμό ασφαλείας και λεπτομερείς οδηγίες.
        </p>
      </div>
    </div>
  ) : (
    <div className="mb-8">
      ...
      <div className="prose prose-lg max-w-none text-gray-700">
        <p className="lead mb-4">
          Discover the magic of Acheron River with an exciting kayaking experience in the crystal-clear waters of Glyki, Thesprotia. 
          Pony Club offers safe and organized kayaking excursions for all ages and experience levels.
        </p>
        
        <p>
          The Acheron River, known from ancient Greek mythology, is one of the most impressive kayaking destinations in Greece. 
          The crystal-clear waters, rich vegetation, and unique natural beauty create the perfect environment for an unforgettable 
          adventure in nature.
        </p>
