...
export async function generateMetadata({
  ...
  const title =
    locale === "el" ? "Για τα σχολεία | Pony Club" : "For Schools | Pony Club";
  const description =
    locale === "el"
      ? "Προγράμματα εκδρομών για σχολεία στις πηγές του Αχέροντα"
      : "School excursion programs at the springs of Acheron River";

  return {
    title,
    description,
    alternates: {
      canonical: `/${locale}/for-schools`,
    },
  };
}
