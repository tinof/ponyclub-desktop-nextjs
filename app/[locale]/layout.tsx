...
export async function generateMetadata(
  ...
  const baseUrl =
    (await parent).metadataBase || new URL("https://www.ponyclub.gr");
  ...
  const commonMetadata: Metadata = {
    ...
    alternates: {
      // Remove hardcoded canonical URL - let individual pages set their own
      languages: {
        en: "/en",
        el: "/el",
      },
  ...
  return (
    <html lang={locale} suppressHydrationWarning>
      <head>
        ...
        {/* LCP Image Preload - Critical for homepage performance */}
        <link
          rel="preload"
          as="image"
