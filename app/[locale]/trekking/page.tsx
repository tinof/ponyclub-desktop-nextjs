    ...
    language === 'el' ? (
      <div className='space-y-4'>
        ...
        <p>
          ...
          προσφέρει απαράμιλλη φυσική ομορφιά αντί για πέρασμα στον Άδη! Η πρόσβαση είναι εύκολη: μπορείτε να
          σταθμεύσετε το όχημά σας ακριβώς δίπλα στην είσοδο της περιοχής των πηγών στη Γλυκή. Το καλύτερο; Η στάθμευση
          και η είσοδος είναι εντελώς δωρεάν, προσκαλώντας σας να ανακαλύψετε τα θαύματά του.
        </p>
        <p>
        ...
        <ol className='list-inside list-decimal space-y-4 pl-4'>
          <li>
            ...
            <ul className='list-none pl-0'>
              ...
              <li>
                <strong>Περιγραφή:</strong> Ιδανική για οικογένειες ή όσους επιθυμούν μια ήπια γνωριμία με την ομορφιά
                του Αχέροντα. Το μονοπάτι ακολουθεί το ποτάμι κάτω από τη δροσερή σκιά των πλατανιών. Θαυμάστε τις
                εντυπωσιακές πηγές όπου το κρυστάλλινο, αλλά δροσερό νερό αναβλύζει απευθείας από τη γη. Ιδανικό σημείο
                για χαλάρωση και – γιατί όχι; – να βουτήξετε τα πόδια σας στα θρυλικά νερά!
              </li>
            </ul>
          </li>
          <li>
            ...
            <ul className='list-none pl-0'>
              ...
              <li>
                <strong>Περιγραφή:</strong> Μια πιο περιπετειώδης διαδρομή που σας οδηγεί βαθύτερα στο φαράγγι του
                Αχέροντα. Περπατήστε κατά μήκος του ποταμού, διασχίστε μικρές γέφυρες και ανακαλύψτε κρυμμένες λίμνες με
                κρυστάλλινα νερά. Η διαδρομή προσφέρει εκπληκτικές θέες του φαραγγιού και ευκαιρίες για φωτογραφίες που
          ...
          <li>
            ...
            <ul className='list-none pl-0'>
              ...
              <li>
                <strong>Περιγραφή:</strong> Για τους πιο έμπειρους πεζοπόρους, αυτή η διαδρομή ακολουθεί τα αρχαία
                μονοπάτια που χρησιμοποιούσαν οι αρχαίοι Έλληνες. Θα περάσετε από ερείπια αρχαίων ναών, θα διασχίσετε
                πυκνά δάση και θα φτάσετε σε απομονωμένες κορυφές με πανοραμική θέα της περιοχής. Μια πραγματικά μυστική
                εμπειρία που συνδυάζει ιστορία, φύση και περιπέτεια.
              </li>
            </ul>
          </li>
        </ol>
      ...
      <div className='space-y-4'>
        ...
        <p>
          ...
          beauty instead of passage to Hades! Access is easy: you can park your vehicle right next to the entrance of
          the springs area in Glyki. The best part? Parking and entry are completely free, inviting you to discover its
          wonders.
        </p>
        ...
        <ol className='list-inside list-decimal space-y-4 pl-4'>
          <li>
            ...
            <ul className='list-none pl-0'>
              ...
              <li>
                <strong>Description:</strong> Perfect for families or those wanting a gentle introduction to Acheron's
                beauty. The path follows the river under the cool shade of plane trees. Marvel at the impressive springs
                where crystal-clear, yet cool water bubbles directly from the earth. An ideal spot for relaxation and –
                why not? – dipping your feet in the legendary waters!
              </li>
            </ul>
          </li>
          <li>
            ...
            <ul className='list-none pl-0'>
              ...
              <li>
                <strong>Description:</strong> A more adventurous route that takes you deeper into the Acheron gorge.
                Walk along the river, cross small bridges, and discover hidden pools with crystal-clear waters. The
                trail offers stunning gorge views and photo opportunities that will remain unforgettable.
              </li>
            </ul>
          </li>
          <li>
            ...
            <ul className='list-none pl-0'>
              ...
              <li>
                <strong>Description:</strong> For more experienced hikers, this trail follows the ancient paths used by
                ancient Greeks. You'll pass ruins of ancient temples, traverse dense forests, and reach isolated peaks
                with panoramic views of the region. A truly mystical experience combining history, nature, and
                adventure.
              </li>
            </ul>
          </li>
